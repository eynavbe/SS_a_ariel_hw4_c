                ...
                if ((head_edge)->endpoint != NULL)
                {
                    while(head_edge){
                        if ((head_edge)->endpoint != NULL)
                        {
                            while(*head_node){
                                // printf("kkkkkk\n");
                                // printf("%d",(head_edge)->endpoint-> node_num);
                                
                                if( (head_edge)->endpoint-> node_num == (*head_node)->node_num) {
                                    // free(&((head_edge)->endpoint));
                                    ...
                                    //     free(p);
                                    //     p = *prev;
                                    //     // (head_edge)->endpoint = p;
                                    // }
                                    // printf("%d",(*head_node)->node_num);
                                    (head_edge)->endpoint = (*head_node);
                                    // printf("\n");
                                    // printf("dddd %d \n",(head_edge)->endpoint->node_num);
                                } 
