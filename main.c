...
void scanfEx4(){
    ...
    int weight;
    int endpoint;
    // array = (pedge*) malloc (2*sizeof(pedge));
    // array1 = array;
    ...
    while ( (a == 'A') || (a == 'T') || (a == 'S') || (a == 'D') || (a == 'B') || (a == 'n'))
    {
        if (a == 'A')
        {
            ...
            while ((a >= '0' && a <= '9') || (a == 'n') )
            {
                ...
                // printf("i %d\n",i);
                // array[i] = p;
                // array = realloc(array,(i+1) * sizeof(struct edge_));
                // i++;
                struct edge_ *p;
                ...
                while ((a >= '0' && a <= '9'))
                {
                    ...
                    if (firstE == 0)
                    {
                        p = newEdge(weight,NULL,&graph_node1,endpoint,NULL);
        ...
        if (a == 'B')
        {
            ...
            first += 1;
            struct edge_ *p = (struct edge_*) malloc (sizeof(struct edge_));
            memset(p, 0, sizeof(sizeof(struct edge_)));
